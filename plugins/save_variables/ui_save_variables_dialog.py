...
# Form implementation generated from reading ui file './plugins/save_variables/save_variables_dialog.ui'
#
...
class Ui_SaveVariablesDialog(object):
    def setupUi(self, SaveVariablesDialog):
        SaveVariablesDialog.setObjectName("SaveVariablesDialog")
        SaveVariablesDialog.resize(600, 450)
        self.verticalLayout = QtWidgets.QVBoxLayout(SaveVariablesDialog)
        self.verticalLayout.setObjectName("verticalLayout")
        self.metadata_table = QtWidgets.QTableWidget(SaveVariablesDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(SaveVariablesDialog)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Close|QtWidgets.QDialogButtonBox.Save)
        self.buttonBox.setObjectName("buttonBox")
        self.verticalLayout.addWidget(self.buttonBox)

        self.retranslateUi(SaveVariablesDialog)
        QtCore.QMetaObject.connectSlotsByName(SaveVariablesDialog)

    def retranslateUi(self, SaveVariablesDialog):
        _translate = QtCore.QCoreApplication.translate
        item = self.metadata_table.horizontalHeaderItem(0)
        item.setText(_translate("SaveVariablesDialog", "Variable"))
        item = self.metadata_table.horizontalHeaderItem(1)
        item.setText(_translate("SaveVariablesDialog", "Value"))
