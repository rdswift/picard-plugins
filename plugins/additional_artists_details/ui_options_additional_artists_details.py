...
class Ui_AdditionalArtistsDetailsOptionsPage(object):
    ...
    def retranslateUi(self, AdditionalArtistsDetailsOptionsPage):
        ...
        self.label_2.setText(_translate("AdditionalArtistsDetailsOptionsPage", "<html><head/><body><p>This option determines whether or not County, Municipality and Subdivision information is included in the artist location variables created. Regardless of these settings, this information will be included if a County, Municipality or Subdivision is the area specified for an artist.</p></body></html>"))
        self.cb_area_county.setText(_translate("AdditionalArtistsDetailsOptionsPage", "Include location county"))
        self.cb_area_municipality.setText(_translate("AdditionalArtistsDetailsOptionsPage", "Include location municipality"))
        self.cb_area_subdivision.setText(_translate("AdditionalArtistsDetailsOptionsPage", "Include location subdivision"))
